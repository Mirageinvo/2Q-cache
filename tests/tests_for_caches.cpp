...
TEST(Cache2Q, TestNine) {
    ...
    int num;
    FILE* f;
    f = fopen("../../tests/files_for_tests/011.dat","r");
    fscanf(f, "%lu%lu", &cache_capacity, &request_num);
    cache_2q<int> cache(cache_capacity);
    for (size_t i = 0; i < request_num; ++i) {
        fscanf(f, "%d", &num);
...
TEST(Cache2Q, TestTen) {
    ...
    int num;
    FILE* f;
    f = fopen("../../tests/files_for_tests/012.dat","r");
    fscanf(f, "%lu%lu", &cache_capacity, &request_num);
    cache_2q<int> cache(cache_capacity);
    for (size_t i = 0; i < request_num; ++i) {
        fscanf(f, "%d", &num);
...
TEST(Cache2Q, TestEleven) {
    ...
    int num;
    FILE* f;
    f = fopen("../../tests/files_for_tests/013.dat","r");
    fscanf(f, "%lu%lu", &cache_capacity, &request_num);
    cache_2q<int> cache(cache_capacity);
    for (size_t i = 0; i < request_num; ++i) {
        fscanf(f, "%d", &num);
...
TEST(Cache2Q, TestTwelve) {
    ...
    int num;
    FILE* f;
    f = fopen("../../tests/files_for_tests/014.dat","r");
    fscanf(f, "%lu%lu", &cache_capacity, &request_num);
    cache_2q<int> cache(cache_capacity);
    for (size_t i = 0; i < request_num; ++i) {
        fscanf(f, "%d", &num);
